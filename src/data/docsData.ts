...
export const docsData: DocItem[] = [
  {
    ...
    l2: 'Overview',
    l3: 'What is Cynclar?',
    content: `Cynclar is an AI-powered data oracle that leverages the x402 protocol for instant, real-time micropayments. It provides divine data, predictive analytics, and event triggers, all paid for on-demand.

Cynclar speaks truth – Divine data, instant wealth.`
  },
  {
    l1: 'Introduction',
    l2: 'Core Concepts',
    l3: 'The Cynclar Ecosystem',
...
3. Real-time Feeds: Subscribe to high-speed data feeds for trading, betting, or automated processes.`
  },
  {
    l1: 'Introduction',
    l2: 'Getting Access',
    l3: 'Accessing the Cynclar API',
    content: `Access to the Cynclar API is managed via the Cynclar Dashboard. Sign up to generate your API keys and pre-fund your account with x402 to begin querying.`
  },
  {
    l1: 'User Guide',
    l2: 'The Cynclar Bot',
    l3: 'Interacting with Cynclar',
    content: `For end-users and traders, the simplest way to query Cynclar is via our official Telegram and Discord bots. Simply send a query, approve the x402 payment, and receive your data instantly in the chat.`
  },
  {
    l1: 'User Guide',
    l2: 'Use Cases',
    l3: 'On-Chain Betting & Events',
    content: `Cynclar powers a new generation of on-chain event derivatives. Platforms (like Pump.fun integrations) can use Cynclar to verify real-world outcomes, allowing users to bet on anything from market movements to sports results, with payouts settled instantly.`
  },
  {
    l1: 'User Guide',
    l2: 'Use Cases',
    l3: 'AI-Assisted Trading',
    content: `A trader can query Cynclar for predictive market sentiment on a specific token just before executing a trade. The AI analyzes real-time data and returns a confidence score, all paid for with a single micropayment.`
  },
  {
    l1: 'Developer Guide',
    l2: 'Authentication',
...
Your API key is linked to your pre-funded x402 account, which is debited for each query.`
  },
  {
    ...
    content: `Cynclar supports two query types.
...
**Asynchronous queries** (e.g., "Predict sentiment for $XYZ in 1h") may take longer and will return a queryId. The result must be retrieved via a webhook or by polling the status endpoint.`
  },
  {
    ...
    content: `To receive results from asynchronous queries or real-time event triggers, you must configure a webhook endpoint in your Cynclar Dashboard. Our server will send a POST request to your URL when an event occurs.`
  },
  {
    l1: 'Developer Guide',
    l2: 'Webhooks',
    l3: 'Securing Your Webhook Endpoint',
    content: `It is critical to verify that incoming webhooks are from Cynclar. Every request includes an X-Cynclar-Signature header. You must verify this signature using your Webhook Signing Secret to prevent spoofing.`
  },
  {
    l1: 'API Reference',
    l2: 'Queries API',
...
Submits a query to the Cynclar network. The cost of the query is automatically debited from your pre-funded account.
