      ...
      <div className="page-content-wrapper">
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem', marginBottom: '3rem' }}>
            <div style={{ padding: '1.5rem', background: 'rgba(225, 147, 147, 0.05)', borderRadius: '8px', border: '1px solid rgba(225, 147, 147, 0.1)' }}>
            ...
            <div style={{ padding: '1.5rem', background: 'rgba(225, 147, 147, 0.05)', borderRadius: '8px', border: '1px solid rgba(225, 147, 147, 0.1)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#e19393' }}></span>
          ...
          <div style={{ marginBottom: '3rem' }}>
            ...
            <textarea
              placeholder="Ask Cynclar anything..."
              style={{
                width: '100%',
                minHeight: '120px',
                padding: '1rem',
