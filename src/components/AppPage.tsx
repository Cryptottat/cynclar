  ...
  return (
    <div className="app-page">
      ...
      <div className="app-page-container">
        <h1 className="app-page-title">Cynclar App</h1>
        <p className="app-page-description">
          The Cynclar application is coming soon. This will be your gateway to AI-powered predictions and instant data insights.
        </p>
