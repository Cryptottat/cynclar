        ...
        <div className="dashboard-terminal">
          <div className="terminal-body">
              <div className="terminal-line">
                <span className="terminal-prompt">cynclar@cloud:~$</span>
                <span className="terminal-command"> cynclar status</span>
              </div>
              <div className="terminal-line">
              ...
              <div className="terminal-line">
                <span className="terminal-prompt">cynclar@cloud:~$</span>
                <span className="terminal-command"> cynclar balance</span>
              </div>
              <div className="terminal-line">
