    ...
    <div className="app-page">
      ...
      <div className="page-content-wrapper">
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '2.5rem', marginBottom: '2rem', fontWeight: '600' }}>Cynclar Query</h1>
          
          {/* Query input */}
          <div style={{ marginBottom: '2rem' }}>
            <textarea
              placeholder="Ask Cynclar anything... (e.g., Predict $SOL sentiment in 1h)"
              style={{
                width: '70%',
                minHeight: '200px',
                padding: '1.5rem',
          ...
          <div>
            ...
            <div
              style={{
                minHeight: '300px',
                padding: '2rem',
                background: 'rgba(225, 147, 147, 0.05)',
                borderRadius: '8px',
                border: '1px solid rgba(225, 147, 147, 0.1)',
                display: 'flex',
                alignItems: 'center',
